...
The previous four-artifact candidate passed [CI run 35849746396](https://github.com/imCinq/fps-tune/actions/runs/35849746396), [26.3 client smoke run 35849746395](https://github.com/imCinq/fps-tune/actions/runs/35849746395), and [1.21.11 client smoke run 35849746471](https://github.com/imCinq/fps-tune/actions/runs/35849746471). Its release assembly produced four targets and is superseded by the three-target release workflow on the updated PR head. Manual checks have been reported good for Fabric 26.3, NeoForge 26.3 preview, and Fabric 1.21.11; NeoForge 1.21.11 still needs a manual exact-JAR and native-settings-screen check.

Keep historical-target builds separate from the v1.3.0 release artifact matrix. Do not claim v1.3.0 ready until the revised three-target package check and required client checks pass.
