...
| Target | Avg FPS before | Avg FPS after | FPS change | p95 frame time before | p95 frame time after | p95 change |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| Minecraft 1.21.11 | 210.10 | 215.17 | +2.4% | 6.65 ms | 5.63 ms | -15.3% |
| Minecraft 26.2 | 78.69 | 102.78 | +30.6% | 17.61 ms | 14.39 ms | -18.3% |

Before means FPS Tune was off; after means it was on. The p95 result is the more direct frame-time smoothness signal: the longer frames were less severe, so this is the result most likely to reduce visible stutter in the tested stress scene.
